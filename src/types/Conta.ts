...
const Conta = {
  ...
  getGruposTransacoes(): GrupoTransacao[] {
    ...
    const listaTransacoes: Transação[] = structuredClone(transacoes);
    const transacoesOrdenadas: Transação[] = listaTransacoes.sort(
  ...
  registrarTransacao(novaTransacao: Transação): void {
